...
//                }
    ...
    public String queryCompanySigcontribute(String community, String company, String contributeType, String timeRange) {
        String index;
        String queryjson;
        String queryStr;
        company = CompanyCN2Cla(community,company);
        ...
        switch (community.toLowerCase()) {
            case "openeuler":
                index = openEuler.getGiteeAllIndex();
                queryjson = openEuler.getcompany_agg_sig_queryStr();
                queryStr = openEuler.getAggCompanySigCountQueryStr(queryjson, contributeType, timeRange, company);
                break;
            case "opengauss":
                index = openGauss.getGiteeAllIndex();
                queryjson = openGauss.getcompany_agg_sig_queryStr();
                queryStr = openGauss.getAggCompanySigCountQueryStr(queryjson, contributeType, timeRange, company);
                break;
            default:
                return "{\"code\":400,\"data\":{\"" + contributeType + "\":\"query error\"},\"msg\":\"query error\"}";
        }
