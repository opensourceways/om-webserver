 ...
 * @description:
 */
public class ContributionCompatorByComments implements Comparator {
    @Override
    public int compare(Object o1, Object o2) {
        ...
        int i = ((Double) (contributionResultVo1.getComments() - contributionResultVo2.getComments())).intValue();
        if(i<0){
            return -1;
        }else {
            return 1;
