...
public enum MessageCodeConfig {
    ...
    E00052("E00052", "Wrong account or password", "账号或密码有误"),
    E00053("E00053", "Fail to modify password", "密码修改失败"),
    E00054("E00054", "Password strength is too low", "密码不符合当前密码强度"),
    E00055("E00055", "Wrong old password", "原始密码不正确"),
    E00056("E00056", "Token invalid or expired", "Token 校验失败"),
    E00057("E00057", "User already exists,log in directly", "用户已存在，请直接登录"),
    E00058("E00058", "At least 6 characters,must contain two types of English, numbers and symbols", "请使用至少 6 位字符作为密码，须包含英文、数字与符号中的两种"),
    ;
